...
router.route("/user-article").get(Auth.authenticateUserAPIToken,Blog.getUserData)
...
router.route("/:id").get(Blog.getDetail).delete(FormData.uploadSettingImages,Blog.remove)
